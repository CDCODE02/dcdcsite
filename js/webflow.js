...
(() => {
  ...
  var Li = s(() => {
    window.tram = (function (e) {
      ...
      function i(l, p, g) {
        return (
          "#" + ((1 << 24) | (l << 16) | (p << 8) | g).toString(16).slice(1)
        );
      }
      function o() {}
      function a(l, p) {
      ...
      var v = (function (l, p, g) {
          ...
          function H(Q, le) {
            ...
            return (
              ...
              (G.open = function (Ce) {
                if (
                  ((re = {}),
                  R(Ce) ? (re = Ce.call(G, $e, he, G, Q)) : T(Ce) && (re = Ce),
                  T(re))
                )
        ...
        h = {
          ease: [
            ...
            function (l, p, g, T) {
              ...
              return (
                p +
                g * (-2.75 * A * R + 11 * R * R + -15.5 * A + 8 * R + 0.25 * l)
              );
            },
          ],
          "ease-in": [
          ...
          "ease-out": [
            ...
            function (l, p, g, T) {
              ...
              return (
                p +
                g * (0.3 * A * R + -1.6 * R * R + 2.2 * A + -1.8 * R + 1.9 * l)
              );
            },
          ],
          "ease-in-out": [
          ...
          "ease-in-out-expo": [
            ...
            function (l, p, g, T) {
              return l === 0
                ...
                ? p + g
                : (l /= T / 2) < 1
                ? (g / 2) * Math.pow(2, 10 * (l - 1)) + p
                : (g / 2) * (-Math.pow(2, -10 * --l) + 2) + p;
            },
          ],
          "ease-in-circ": [
          ...
          "ease-in-out-circ": [
            ...
            function (l, p, g, T) {
              return (l /= T / 2) < 1
                ? (-g / 2) * (Math.sqrt(1 - l * l) - 1) + p
                : (g / 2) * (Math.sqrt(1 - (l -= 2) * l) + 1) + p;
            },
          ],
          "ease-in-back": [
        ...
        D = function (l) {
          ...
          for (p = 0; p < R.length; p++)
            T += R[p].charAt(0).toUpperCase() + R[p].slice(1);
          for (p = 0; p < _.length; p++)
            if (((g = _[p] + T), g in L.style))
              return { dom: g, css: q[p] + l };
        },
        M = (t.support = {
      ...
      var ie = (t.frame = (function () {
        ...
        Ge = v(function (l) {
          function p(k, ne) {
            ...
            if (!ne.weak || !this.props[oe]) {
              var Be = Ne[0],
                xe = this.props[oe];
              return (
                xe || (xe = this.props[oe] = new Be.Bare()),
          ...
          function he() {
            ...
            (pe = pe.join(",")),
              this.style !== pe &&
                ((this.style = pe), (this.el.style[M.transition.dom] = pe));
          }
          function $e(k, ne, pe) {
            var oe,
              Ne,
              ...
              (Be = k[oe]),
                oe in fe
                  ? (ge.transform || (ge.transform = {}),
                    (ge.transform[oe] = Be))
                  : (b.test(oe) && (oe = r(oe)),
                    oe in V ? (ge[oe] = Be) : (xe || (xe = {}), (xe[oe] = Be)));
            for (oe in ge) {
          ...
          (l.init = function (k) {
            ...
            M.backface &&
              ce.hideBackface &&
              d(this.el, M.backface.css, "hidden");
          }),
            Ue("add", p),
            Ue("start", g),
            Ue("wait", T),
        ...
        Y = v(function (l) {
          ...
          function T(A) {
            ...
            return (H ? i(H[1], H[2], H[3]) : A).replace(
              /#(\w)(\w)(\w)$/,
              "#$1$1$2$2$3$3"
            );
          }
          ...
          (l.init = function (A, H, Q, le) {
            ...
            Q[2] && (G = Q[2]),
              ...
              (this.name = G),
              (this.type = Q[1]),
              (this.duration = c(H[1], this.duration, R.duration)),
              (this.ease = g(H[2], this.ease, R.ease)),
              (this.delay = c(H[3], this.delay, R.delay)),
          ...
          (l.init = function () {
            ...
            (l.values = function (T) {
              var R,
                A = {};
              return (
                g.call(this, T, function (H, Q, le) {
                  (A[H] = Q),
                    this.current[H] === void 0 &&
                      ((R = 0),
                      ~H.indexOf("scale") && (R = 1),
                      (this.current[H] = this.convert(R, le)));
                }),
                A
              );
            });
          ...
          (l.init = function (g) {
            ...
            (l.render = function (g) {
              ...
              for (T = A; T--; )
                (R = this.tweens[T]),
                  R.context &&
                    (R.render(g), (this.current[R.name] = R.value), (H = !0));
              return H
      ...
      (t.fallback = function (l) {
        ...
        (t.delay = function (l, p, g) {
          return new vt({ complete: p, duration: l, context: g });
        }),
      ...
      var d = e.style,
        ...
        V = {
          color: [me, P],
          background: [me, P, "background-color"],
          "outline-color": [me, P],
          "border-color": [me, P],
          "border-top-color": [me, P],
          "border-right-color": [me, P],
          "border-bottom-color": [me, P],
          "border-left-color": [me, P],
          "border-width": [Y, x],
          "border-top-width": [Y, x],
          "border-right-width": [Y, x],
          "border-bottom-width": [Y, x],
          "border-left-width": [Y, x],
          "border-spacing": [Y, x],
          "letter-spacing": [Y, x],
          margin: [Y, x],
          "margin-top": [Y, x],
          ...
          e.forEach =
            function (_, q, D) {
              ...
              if (E && _.forEach === E) _.forEach(q, D);
                ...
                for (var M = 0, j = _.length; M < j; M++)
                  if (q.call(D, _[M], M, _) === t) return;
              } else
                for (var z = e.keys(_), M = 0, j = z.length; M < j; M++)
                  if (q.call(D, _[z[M]], z[M], _) === t) return;
              return _;
            });
      (e.map = e.collect =
        function (_, q, D) {
        ...
        (e.debounce = function (_, q, D) {
          var M,
            ...
            Ge = function () {
              var Te = e.now() - ie;
              Te < q
                ? (M = setTimeout(Ge, q - Te))
                : ((M = null), D || ((we = _.apply(z, j)), (z = j = null)));
            };
          return function () {
...
` +
  ...
  var ut = s((KU, Ss) => {
    ...
    var sn = navigator.userAgent.toLowerCase(),
      ...
      aI = (ae.env.ios = /(ipod|iphone|ipad)/.test(sn));
    ae.env.safari = /safari/.test(sn) && !oI && !aI;
    var xi;
    Ts &&
      rI.on("touchstart mousedown", function (e) {
        xi = e.target;
      });
    ae.validClick = Ts
      ? function (e) {
    ...
    As.define(
      ...
      (bs.exports = function (e) {
        ...
        t.ready = function () {
          ...
          /\.webflow\.io$/i.test(w) && a.hostname !== w && (y = !0),
            y &&
              !u &&
              ((f = f || v()),
              h(),
  ...
  var Ds = s(($U, xs) => {
    ...
    var Gi = window.jQuery,
      ...
      ln = {
        ...
        intro: function (e, t) {
          t.__wf_intro ||
            ((t.__wf_intro = !0), Gi(t).triggerHandler(Je.types.INTRO));
        },
        outro: function (e, t) {
          t.__wf_intro &&
            ((t.__wf_intro = null), Gi(t).triggerHandler(Je.types.OUTRO));
        },
      };
    Je.triggers = {};
    Je.types = { INTRO: "w-ix-intro" + Ls, OUTRO: "w-ix-outro" + Ls };
    Je.init = function () {
  ...
  var Vi = s((ZU, Gs) => {
    ...
    fn.triggers = {};
    fn.types = { INTRO: "w-ix-intro" + Fs, OUTRO: "w-ix-outro" + Fs };
  ...
  var _u = s((_B, gu) => {
    ...
    !vn &&
      ...
      ((ke = zi.match(/Edge\/(\d+)/)),
      (!ke || ke[1] >= 74) &&
        ((ke = zi.match(/Chrome\/(\d+)/)), ke && (vn = +ke[1])));
    gu.exports = vn;
  });
  var Yi = s((yB, Iu) => {
    var yu = _u(),
  ...
  var no = s((LB, Ku) => {
    var dT = de(),
      ...
      qt = dT.Symbol,
      ju = qt && qt.for,
      ET = ku ? qt : (qt && qt.withoutSetter) || vT;
  ...
  var $u = s((xB, Qu) => {
    ...
    Qu.exports = function (e, t) {
      ...
      if (r) {
        if (
          (t === void 0 && (t = "default"), (n = gT(r, e, t)), !zu(n) || Yu(n))
        )
          return n;
  ...
  var mc = s((kB, Tc) => {
    var nm = pc(),
      ...
      lm = function (e) {
        return function (t) {
          var r;
          if (!im(t) || (r = Nr(t)).type !== e)
            throw go("Incompatible receiver, " + e + " required");
          return r;
        };
      };
    nm || Eo.state
      ? ((gt = Eo.state || (Eo.state = new um())),
        (_c = po(gt.get)),
        (ho = po(gt.has)),
        (yc = po(gt.set)),
        (yn = function (e, t) {
    ...
    var gt, _c, ho, yc, Pt;
    Tc.exports = { set: yn, get: Nr, has: In, enforce: cm, getterFor: lm };
  });
  var Ac = s((KB, Sc) => {
    var _o = Nt(),
      fm = ht(),
      Oc = Function.prototype,
      dm = _o && Object.getOwnPropertyDescriptor,
      yo = fm(Oc, "name"),
      pm = yo && function () {}.name === "something",
      vm = yo && (!_o || (_o && dm(Oc, "name").configurable));
    Sc.exports = { EXISTS: yo, PROPER: pm, CONFIGURABLE: vm };
  });
  var Nc = s((zB, Cc) => {
    var Em = de(),
      bc = tt(),
    ...
    (Cc.exports = function (e, t, r, n) {
      ...
      if (
        (bc(r) &&
          ...
          (!hm(r, "name") || (ym && r.name !== u)) && Rc(r, "name", u),
          (c = Tm(r)),
    ...
    Jc.exports = function (e, t) {
      ...
      if (
        ...
        for (u in t) {
          if (
            ((f = t[u]),
            e.noTargetGet ? ((E = iO(a, u)), (c = E && E.value)) : (c = a[u]),
            (o = cO(n ? u : r + (i ? "." : "#") + u, e.forced)),
            !o && c !== void 0)
          ) {
  ...
  var il = s((cW, nl) => {
    ...
    nl.exports = dO
      ...
      : function (t, r) {
          vO(t);
          for (var n = EO(r), i = hO(r), o = i.length, a = 0, u; o > a; )
            pO.f(t, (u = i[a++]), n[u]);
          return t;
        };
  });
  ...
  var vl = s((fW, pl) => {
    ...
    pl.exports =
      ...
      function (t, r) {
        ...
        return (
          t !== null
            ? ((Ao[bo] = _O(t)), (n = new Ao()), (Ao[bo] = null), (n[fl] = t))
            : (n = On()),
          r === void 0 ? n : yO(n, r)
        );
      };
  ...
  var hl = s((dW, El) => {
    var AO = no(),
      ...
      wo = AO("unscopables"),
      Co = Array.prototype;
    Co[wo] == null && RO.f(Co, wo, { configurable: !0, value: bO(null) });
  ...
  var Pl = s((mW, ql) => {
    var Cl = Yt(),
      Nl = Object.prototype,
      BO = Nl.hasOwnProperty,
      WO = Nl.toString,
      Pr = Cl ? Cl.toStringTag : void 0;
    function HO(e) {
      var t = BO.call(e, Pr),
        r = e[Pr];
      try {
  ...
  var Fo = s((Lr) => {
    ...
    var kl = (Lr.ActionTypes = { INIT: "@@redux/INIT" });
    function zl(e, t, r) {
      var n;
      if (
      ...
      return (
        h({ type: kl.INIT }),
        (n = { dispatch: h, subscribe: v, getState: E, replaceReducer: y }),
        (n[jl.default] = w),
        n
      );
    }
      ...
      return function (n) {
        return function (i, o, a) {
          ...
          return (
            ...
            (c = NS.default.apply(void 0, f)(u.dispatch)),
            wS({}, u, { dispatch: c })
          );
        };
      };
  ...
  var uf = s((Rn) => {
    ...
    Rn.ixData = void 0;
    var Lb = De(),
      { IX2_RAW_DATA_IMPORTED: xb } = Lb.IX2EngineActionTypes,
      Db = (e = Object.freeze({}), t) => {
        switch (t.type) {
          case xb:
      ...
      s0 = (e = wf, t) => {
        switch (t.type) {
          case Qb: {
            ...
            return (0, rt.merge)(e, { hasBoundaryNodes: r, reducedMotion: n });
          }
          case $b:
          ...
          case t0: {
            ...
            return (0, rt.setIn)(e, ["eventState", r], n);
          }
          case n0: {
            let { actionListId: r, isPlaying: n } = t.payload;
            return (0, rt.setIn)(e, ["playbackState", r], n);
          }
          case i0: {
            ...
            return (0, rt.merge)(e, { viewportWidth: r, mediaQueryKey: o });
          }
          case o0:
  ...
  var Vn = s((Vr, ir) => {
    var dC = Ke(),
      ...
      wp = Np && typeof ir == "object" && ir && !ir.nodeType && ir,
      vC = wp && wp.exports === Np,
  ...
  var Gp = s((Ur, or) => {
    var $C = No(),
      ...
      Br = Fp && typeof or == "object" && or && !or.nodeType && or,
      ZC = Br && Br.exports === Fp,
      ua = ZC && $C.process,
      JC = (function () {
        try {
  ...
  var kn = s((y5, pv) => {
    var fa = tv(),
      ...
      JN = ar(Ea),
      xt = dv;
    ((fa && xt(new fa(new ArrayBuffer(1))) != fv) ||
      (da && xt(new da()) != sv) ||
      (pa && xt(pa.resolve()) != uv) ||
      (va && xt(new va()) != cv) ||
      (Ea && xt(new Ea()) != lv)) &&
  ...
  var Tv = s((I5, Iv) => {
    ...
    function aq(e, t, r, n, i, o) {
      ...
      if (h && !E)
        return (
          o || (o = new ha()),
          a || nq(e) ? eq(e, t, r, n, i, o) : tq(e, t, c, r, n, i, o)
        );
      if (!(r & iq)) {
        var y = E && yv.call(e, "__wrapped__"),
          w = v && yv.call(t, "__wrapped__");
        if (y || w) {
          var O = y ? e.value() : e,
            C = w ? t.value() : t;
  ...
  var jr = s((D5, $v) => {
    var Kq = Se(),
      ...
      Qq = Qv();
    function $q(e, t) {
      return Kq(e) ? e : zq(e, t) ? [e] : Yq(Qq(e));
    }
    $v.exports = $q;
  });
  var sr = s((M5, Zv) => {
  ...
  var ei = s((qe) => {
    ...
    var PE = xE.split("transform")[0],
      mL = PE ? PE + "TransformStyle" : "transformStyle";
  ...
  var Ra = s((ij, XE) => {
    var OL = 4,
      ...
      kr = 11,
      ti = 1 / (kr - 1),
      RL = typeof Float32Array == "function";
    function DE(e, t) {
      return 1 - 3 * t + 3 * e;
    }
    function ME(e, t) {
  ...
  var wa = s(($) => {
    ...
    $.ease = qL;
    var PL = (0, ni.default)(0.42, 0, 1, 1);
    $.easeIn = PL;
    var LL = (0, ni.default)(0, 0, 0.58, 1);
    $.easeOut = LL;
    var xL = (0, ni.default)(0.42, 0, 0.58, 1);
    $.easeInOut = xL;
    function DL(e) {
      return Math.pow(e, 2);
    }
  ...
  var Na = s((Kr) => {
    ...
    function _x(e, t, r) {
      return t === 0
        ...
        : t === 1
        ? 1
        : Ca(r ? (t > 0 ? r(t) : t) : t > 0 && e && VE[e] ? VE[e](t) : t);
    }
  });
  var HE = s((ur) => {
    "use strict";
        ...
        switch (t.type) {
          ...
          case Cx: {
            let {
              ...
              c = e;
            return (
              (0, ii.getIn)(c, [r, n]) !== n && (c = WE(c, n, a, r, o)),
              qa(c, r, u, i, o)
            );
          }
          case Nx: {
    ...
    function WE(e, t, r, n, i) {
      let o =
        r === yx ? (0, ii.getIn)(i, ["config", "target", "objectId"]) : null;
  ...
  var lh = s((Tj, ch) => {
    ...
    function OD(e, t, r) {
      ...
      return (
        r !== void 0 &&
          ((i = ID(r)), (i = r < 0 ? TD(n + i, 0) : mD(i, n - 1))),
        _D(e, yD(t, 3), i, !0)
      );
    }
    ch.exports = OD;
  ...
  var vh = s((oi) => {
    ...
    function wD(e, t) {
      ...
      for (let i = 0; i < r.length; i++)
        if (!RD.call(t, r[i]) || !ph(e[r[i]], t[r[i]])) return !1;
      return !0;
    }
    var CD = wD;
    oi.default = CD;
  ...
  var Dh = s((se) => {
    ...
    var Tt = ui(zE()),
      ...
      kD = "OBJECT_VALUE",
      Ch = (e) => e.trim(),
      Xa = Object.freeze({ [vr]: Ah, [Er]: UD, [hr]: BD }),
      Nh = Object.freeze({
    ...
    function Va({
      ...
      if (
        (ee
          ? ((K = W.limitAffectedElements), (L = q), (_ = E(W)))
          : (L = _ = E({ id: b, selector: P, selectorGuids: x })),
        t && F)
      ) {
        let D = r && (_ || F === !0) ? [r] : v(q);
        if (_) {
        ...
        case pr: {
          ...
          return (
            ...
            n.config.heightUnit === mt
              ? (E = Th.test(c) ? parseFloat(c) : parseFloat(r.height))
    ...
    function vM(e, t, r, n, i) {
      ...
      Gt(e, Pe.TRANSFORM_PREFIXED, i),
        ...
        gM(n, r) && a(e, Pe.TRANSFORM_STYLE_PREFIXED, XD);
    }
    function EM(e, t, r, n) {
      let i = (0, Ma.default)(t, (a, u, c) => `${a} ${c}(${u}${dM(c, r)})`, ""),
        { setStyle: o } = n;
      Gt(e, zr, n), o(e, zr, i);
    }
    function hM(e, t, r, n) {
    ...
    function OM(e, t, r, n, i, o) {
      ...
      switch (n.actionTypeId) {
        case pr: {
          ...
          f !== void 0 &&
            (u === mt && (u = "px"), Gt(e, it, o), a(e, it, f + u)),
            E !== void 0 &&
              (c === mt && (c = "px"), Gt(e, ot, o), a(e, ot, E + c));
          break;
        }
        case Zr: {
          EM(e, r, n.config, o);
    ...
    function AM({ store: e, elementApi: t }) {
      ...
      Object.keys(n).forEach((o) => {
        ...
        Object.keys(i).forEach((o) => {
          mh({ actionList: i[o], elementApi: t });
        });
    }
    function mh({ actionList: e = {}, event: t, elementApi: r }) {
      ...
      n &&
        n.forEach((o) => {
          Oh({ actionGroup: o, event: t, elementApi: r });
        }),
        i &&
          i.forEach((o) => {
            let { continuousActionGroups: a } = o;
            a.forEach((u) => {
              Oh({ actionGroup: u, event: t, elementApi: r });
            });
          });
    }
    function Oh({ actionGroup: e, event: t, elementApi: r }) {
      ...
      n.forEach(({ actionTypeId: i, config: o }) => {
        let a;
        (0, at.isPluginType)(i)
          ? (a = (0, at.clearPlugin)(i))
          : (a = Lh({ effect: RM, actionTypeId: i, elementApi: r })),
          Va({ config: o, event: t, elementApi: r }).forEach(a);
      });
    }
    function bM(e, t, r) {
      ...
      i(e, cr) && Lh({ effect: Ph, actionTypeId: o, elementApi: r })(e);
    }
    var Lh =
  ...
  var Xh = s((fi) => {
    ...
    var Mh = De(),
      ...
      _r = Jt(),
      {
        ...
        IX2_SESSION_STOPPED: BM,
        IX2_INSTANCE_ADDED: WM,
        IX2_INSTANCE_STARTED: HM,
        IX2_INSTANCE_REMOVED: jM,
        IX2_ANIMATION_FRAME_CHANGED: kM,
      } = Mh.IX2EngineActionTypes,
      {
        optimizeFloat: li,
        applyEasing: Gh,
        createBezierEasing: KM,
      } = Fh.IX2EasingUtils,
      { RENDER_GENERAL: zM } = Mh.IX2EngineConstants,
      {
      ...
      $M = (e, t) => {
        ...
        for (let U = 0, { length: W } = i; U < W; U++) {
          ...
          if ((U === 0 && (I = K[0]), b >= ee)) {
            ...
            let L = i[U + 1],
              _ = L && b !== ee;
            (P = _ ? L.actionItems[0] : null),
              _ && ((x = ee / 100), (N = (L.keyframe - ee) / 100));
          }
        }
        let F = {};
        if (I && !P)
          ...
          for (let K = 0, { length: L } = o; K < L; K++) {
            let _ = o[K],
              q = Ba(c, _, I.config),
              j = (Ba(c, _, P.config) - q) * ee + q;
            F[_] = j;
          }
        }
        return (0, _r.merge)(e, { position: S, current: F });
      },
      ZM = (e, t) => {
        let {
            active: r,
        ...
        if (r && n) {
          ...
          if (u) {
            let U = b - i,
              W = C + S,
              ee = li(Math.min(Math.max(0, U / W), 1));
            e = (0, _r.set)(e, "verboseTimeElapsed", W * ee);
          }
          if (I < 0) return e;
          let P = li(Math.min(Math.max(0, I / C), 1)),
            x = Gh(O, P, y),
            N = {},
            F = null;
          return (
        ...
        switch (t.type) {
          ...
          case WM: {
            let {
              ...
              ee = YM(W),
              K = QM(ee, W),
              L = Object.keys(h).filter((q) => h[q] != null),
              { easing: _ } = i.config;
            return (0, _r.set)(e, r, {
              id: r,
              elementId: n,
              ...
              skipToValue: U,
              customEasingFn:
                Array.isArray(_) && _.length === 4 ? KM(_) : void 0,
            });
          }
          case HM: {
  ...
  var ng = s((Lj, rg) => {
    var Qh = "\\ud800-\\udfff",
      ...
      eg = F2 + "?",
      tg = "[" + D2 + "]?",
      X2 = "(?:" + G2 + "(?:" + [$h, Zh, Jh].join("|") + ")" + tg + eg + ")*",
      V2 = tg + eg + X2,
      U2 = "(?:" + [$h + Wa + "?", Wa, Zh, Jh, M2].join("|") + ")",
      Yh = RegExp(Ha + "(?=" + Ha + ")|" + U2 + V2, "g");
    function B2(e) {
  ...
  var ka = s((Gj, dg) => {
    ...
    function o1(e, t, r) {
      t == "__proto__" && fg
        ? fg(e, t, { configurable: !0, enumerable: !0, value: r, writable: !0 })
        : (e[t] = r);
    }
    dg.exports = o1;
  });
  var vg = s((Xj, pg) => {
    ...
    function l1(e, t, r) {
      var n = e[t];
      (!(c1.call(e, t) && s1(n, r)) || (r === void 0 && !(t in e))) &&
        a1(e, t, r);
    }
    pg.exports = l1;
  });
  ...
  var vi = s((J) => {
    ...
    var $g = PF(xr()),
      ...
      LF = Xt(),
      {
        ...
        IX2_SESSION_INITIALIZED: DF,
        IX2_SESSION_STARTED: MF,
        IX2_SESSION_STOPPED: FF,
        IX2_PREVIEW_REQUESTED: GF,
        IX2_PLAYBACK_REQUESTED: XF,
        IX2_STOP_REQUESTED: VF,
        IX2_CLEAR_REQUESTED: UF,
        IX2_EVENT_LISTENER_ADDED: BF,
        IX2_TEST_FRAME_RENDERED: WF,
        IX2_EVENT_STATE_CHANGED: HF,
        IX2_ANIMATION_FRAME_CHANGED: jF,
        IX2_PARAMETER_CHANGED: kF,
        IX2_INSTANCE_ADDED: KF,
        IX2_INSTANCE_STARTED: zF,
        IX2_INSTANCE_REMOVED: YF,
        IX2_ELEMENT_STATE_CHANGED: QF,
        IX2_ACTION_LIST_PLAYBACK_CHANGED: $F,
        IX2_VIEWPORT_WIDTH_CHANGED: ZF,
        IX2_MEDIA_QUERIES_DEFINED: JF,
      } = Zg.IX2EngineActionTypes,
      { reifyState: eG } = LF.IX2VanillaUtils,
      tG = (e) => ({ type: xF, payload: (0, $g.default)({}, eG(e)) });
    ...
    var aG = ({
      actionTypeId: e = Zg.ActionTypeConsts.GENERAL_START_ACTION,
      actionListId: t,
      actionItemId: r,
      eventId: n,
      allowEvents: i,
    ...
    var sG = (e) => ({ type: VF, payload: { actionListId: e } });
    J.stopRequested = sG;
    var uG = () => ({ type: UF });
    J.clearRequested = uG;
    var cG = (e, t) => ({
    ...
    var lG = (e = 1) => ({ type: WF, payload: { step: e } });
    J.testFrameRendered = lG;
    var fG = (e, t) => ({ type: HF, payload: { stateKey: e, newState: t } });
    J.eventStateChanged = fG;
    var dG = (e, t) => ({ type: jF, payload: { now: e, parameters: t } });
    J.animationFrameChanged = dG;
    var pG = (e, t) => ({ type: kF, payload: { key: e, value: t } });
    J.parameterChanged = pG;
    var vG = (e) => ({ type: KF, payload: (0, $g.default)({}, e) });
    J.instanceAdded = vG;
    var EG = (e, t) => ({ type: zF, payload: { instanceId: e, time: t } });
    J.instanceStarted = EG;
    var hG = (e) => ({ type: YF, payload: { instanceId: e } });
  ...
  var t_ = s((be) => {
    ...
    var TG = Xt(),
      mG = De(),
      { ELEMENT_MATCHES: za } = TG.IX2BrowserSupport,
      {
        IX2_ID_DELIMITER: Jg,
        HTML_ELEMENT: OG,
        PLAIN_OBJECT: SG,
    ...
    function CG({ id: e, selector: t }) {
      if (e) {
        ...
        if (e.indexOf(Jg) !== -1) {
          let n = e.split(Jg),
            i = n[0];
          if (((r = n[1]), i !== document.documentElement.getAttribute(e_)))
            return null;
        }
  ...
  var c_ = s((uk, u_) => {
    var a_ = Yt(),
      WG = Xr(),
      HG = Se(),
      s_ = a_ ? a_.isConcatSpreadable : void 0;
    function jG(e) {
  ...
  var y_ = s((dk, __) => {
    ...
    function ZG(e, t, r) {
      return (
        ...
        function () {
          for (
            var n = arguments, i = -1, o = g_(n.length - t, 0), a = Array(o);
            ++i < o;
  ...
  var $a = s((mk, U_) => {
    ...
    function TX(e) {
      for (
        var t = e.name + "", r = V_[t], n = IX.call(V_, t) ? r.length : 0;
        n--;
    ...
    function QX(e) {
      return BX(function (t) {
        ...
        for (n = a ? n : r; ++n < r; ) {
          o = t[n];
          var u = Za(o),
            c = u == "wrapper" ? WX(o) : void 0;
          c &&
          J_(c[0]) &&
          c[1] == (zX | kX | KX | YX) &&
          !c[4].length &&
          c[9] == 1
            ? (a = a[Za(c[0])].apply(a, c[3]))
            : (a = o.length == 1 && J_(o) ? a[u]() : a.thru(o));
        }
        return function () {
          var f = arguments,
            E = f[0];
  ...
  var sy = s((qk, ay) => {
    ...
    function tV(e, t, r) {
      return (
        ...
        r !== void 0 && ((r = Ja(r)), (r = r === r ? r : 0)),
        t !== void 0 && ((t = Ja(t)), (t = t === t ? t : 0)),
        eV(Ja(e), t, r)
      );
    }
    ay.exports = tV;
  ...
  var Ay = s((Ai) => {
    ...
    var Ve = Si(xr()),
      ...
      nn = { handler: ze(st, Fe) },
      Oy = (0, Ve.default)({}, nn, { types: [ts, Iy].join(" ") }),
      rs = [
      ...
      ns = { types: rs },
      CV = { PAGE_START: yy, PAGE_FINISH: _y },
      tn = (() => {
      ...
      Sy = (e) => (t, r) => {
        let { type: n } = t.nativeEvent,
          i = [ts, Iy].indexOf(n) !== -1 ? n === ts : r.isActive,
      ...
      LV = (e) => (t, r) => {
        let n = (0, Ve.default)({}, r, { elementVisible: PV(t) });
        return (
      ...
      mi = (e = !0) =>
        (0, Ve.default)({}, Oy, {
          handler: ze(
            e ? st : rn,
            Sy((t, r) => (r.isActive ? nn.handler(t, r) : r))
          ),
        }),
      Oi = (e = !0) =>
        (0, Ve.default)({}, Oy, {
          handler: ze(
            e ? st : rn,
            Sy((t, r) => (r.isActive ? r : nn.handler(t, r)))
          ),
        }),
      vy = (0, Ve.default)({}, ns, {
        handler: LV((e, t) => {
      ...
      FV = {
        ...
        [hV]: mi(),
        [gV]: Oi(),
        [AV]: { types: "ecommerce-cart-open", handler: ze(st, Fe) },
        [SV]: { types: "ecommerce-cart-close", handler: ze(st, Fe) },
        [aV]: {
          types: "click",
          handler: ze(
            st,
        ...
        [uV]: (0, Ve.default)({}, nn, { types: "mousedown" }),
        [cV]: (0, Ve.default)({}, nn, { types: "mouseup" }),
        [lV]: {
          types: ly,
          handler: ze(
            st,
            ...
            switch (a) {
              ...
              default: {
                ...
                let x = t.getBoundingClientRect(),
                  { left: N, top: F, width: U, height: W } = x;
                if (!P && !xV({ left: v, top: h }, x)) break;
                (I = !0), (S = O ? (v - N) / U : (h - F) / W);
                break;
              }
            }
            return (
              C && (S > 1 - Ey || S < Ey) && (S = Math.round(S)),
              (a !== Vt.EventBasedOn.ELEMENT || I || I !== o.elementHovered) &&
                ((S = f ? 1 - S : S),
                e.dispatch((0, Ti.parameterChanged)(b, S))),
              { elementHovered: I, clientX: v, clientY: h, pageX: y, pageY: w }
            );
          },
        },
        [bV]: {
        ...
        [OV]: {
          ...
          handler: (
            ...
            if (E === Vt.EventBasedOn.VIEWPORT) {
              ...
              return (
                P !== i.scrollPercent &&
                  t.dispatch((0, Ti.parameterChanged)(h, P)),
                { scrollPercent: P }
              );
            } else {
              let P = cy(n, h),
                ...
                F = (O ? b : 0) / 100;
              (N = y ? N : 1 - N), (F = w ? F : 1 - F);
              let U = x.top + Math.min(x.height * N, f),
                ee = x.top + x.height * F - U,
                K = Math.min(f + ee, c),
                _ = Math.min(Math.max(0, f - U), K) / K;
              return (
                _ !== i.scrollPercent &&
                  t.dispatch((0, Ti.parameterChanged)(P, _)),
                { scrollPercent: _ }
              );
            }
          },
  ...
  var is = s((St) => {
    ...
    function pU(e) {
      Ut({ store: e, select: ({ ixRequest: t }) => t.preview, onChange: hU }),
        ...
        Ut({ store: e, select: ({ ixRequest: t }) => t.stop, onChange: _U }),
        Ut({ store: e, select: ({ ixRequest: t }) => t.clear, onChange: yU });
    }
    function vU(e) {
      Ut({
        store: e,
    ...
    function hU({ rawData: e, defer: t }, r) {
      let n = () => {
        Ci({ store: r, rawData: e, allowEvents: !0 }), qy();
      };
      t ? setTimeout(n, 0) : n();
    }
    function qy() {
    ...
    function gU(e, t) {
      ...
      if (n && i && E && u) {
        ...
        v && (E = nU({ actionList: v, actionItemId: i, rawData: E }));
      }
      if (
        ...
        ls({ store: t, actionListId: n }),
          Ly({ store: t, actionListId: n, eventId: o });
        let v = fs({
          store: t,
          eventId: o,
          actionListId: n,
    ...
    function _U({ actionListId: e }, t) {
      e ? ls({ store: t, actionListId: e }) : xy({ store: t }), Ni(t);
    }
    function yU(e, t) {
      Ni(t), Ny({ store: t, elementApi: ye });
    }
    ...
    function OU({
      ...
      S.forEach((P) => {
        ...
        N.forEach((F) => {
          let { actionTypeId: U } = F,
            { target: W } = F.config;
          if (!W) return;
          let ee = W.boundaryMode ? I : null,
            K = sU(W) + as + U;
        ...
        C.forEach(({ element: P, key: x }) => {
          let N = O[x],
            F = (0, Ot.default)(N, "[0].actionItems[0]", {}),
            { actionTypeId: U } = F,
            W = us(U) ? cs(U)(P, F) : null,
            ee = ss({ element: P, actionItem: F, elementApi: ye }, W);
          ds({
            store: e,
            element: P,
            eventId: n,
    ...
    function qU({ logic: e, store: t, events: r }) {
      ...
      (0, on.default)(u, (v, h) => {
        let y = r[h],
          { action: w, id: O, mediaQueries: C = o.mediaQueryKeys } = y,
          { actionListId: S } = w.config;
        uU(C, o.mediaQueryKeys) || t.dispatch((0, Ee.mediaQueriesDefined)()),
          w.actionTypeId === Ye.ActionTypeConsts.GENERAL_CONTINUOUS_ACTION &&
            (Array.isArray(y.config) ? y.config : [y.config]).forEach((I) => {
              let { continuousParameterGroupId: P } = I,
                x = (0, Ot.default)(a, `${S}.continuousParameterGroups`, []),
                N = (0, UV.default)(x, ({ id: W }) => W === P),
                F = (I.smoothing || 0) / 100,
          ...
          (w.actionTypeId === Ye.ActionTypeConsts.GENERAL_START_ACTION ||
            os(w.actionTypeId)) &&
            Ly({ store: t, actionListId: S, eventId: O });
      });
      let c = (v) => {
          ...
          CU(u, (y, w, O) => {
            let C = r[w],
              S = h.eventState[O],
              { action: b, mediaQueries: I = o.mediaQueryKeys } = C;
            ...
            b.actionTypeId === Ye.ActionTypeConsts.GENERAL_CONTINUOUS_ACTION
              ? (Array.isArray(C.config) ? C.config : [C.config]).forEach(P)
              : P();
          });
        },
        f = (0, kV.default)(c, dU),
        E = ({ target: v = document, types: h, throttle: y }) => {
          h.split(" ")
            .filter(Boolean)
            .forEach((w) => {
              let O = y ? f : c;
              v.addEventListener(w, O),
                t.dispatch((0, Ee.eventListenerAdded)(v, [w, O]));
            });
        };
    ...
    function Ly({ store: e, actionListId: t, eventId: r }) {
      ...
      if (c && c.useFirstGroupAsInitialState) {
        ...
        f.forEach((v) => {
          var h;
          let { config: y, actionTypeId: w } = v,
            O =
              (y == null || (h = y.target) === null || h === void 0
                ? void 0
                : h.useEventTarget) === !0
                ? { target: u.target, targets: u.targets }
                : y,
            C = Ri({ config: O, event: u, elementApi: ye }),
            S = us(w);
          C.forEach((b) => {
            let I = S ? cs(w)(b, v) : null;
            ds({
              destination: ss({ element: b, actionItem: v, elementApi: ye }, I),
              immediate: !0,
              store: e,
              element: b,
              eventId: r,
    ...
    function fs({
      ...
      let { ixData: f, ixSession: E } = e.getState(),
        ...
        w = (0, Ot.default)(f, `actionLists.${i}`, {}),
        { actionItemGroups: O, useFirstGroupAsInitialState: C } = w;
      if (!O || !O.length) return !1;
      o >= O.length && (0, Ot.default)(h, "config.loop") && (o = 0),
        o === 0 && C && o++;
      let b =
          (o === 0 || (o === 1 && C)) &&
          os((c = h.action) === null || c === void 0 ? void 0 : c.actionTypeId)
            ? h.config.delay
            : void 0,
        I = (0, Ot.default)(O, [o, "actionItems"], []);
      if (!I.length || !wi(y, E.mediaQueryKey)) return !1;
      let P = E.hasBoundaryNodes && r ? ye.getClosestElement(r, bi) : null,
        x = eU(I),
        N = !1;
      return (
        I.forEach((F, U) => {
          let { config: W, actionTypeId: ee } = F,
            K = us(ee),
            { target: L } = W;
          if (!L) return;
          ...
          Ri({
            ...
            let j = K ? cs(ee)(D, F) : null,
              z = K ? lU(ee)(D, F) : null;
            N = !0;
            let ie = x === U && M === 0,
              we = tU({ element: D, actionItem: F }),
              Ge = ss({ element: D, actionItem: F, elementApi: ye }, j);
            ds({
              store: e,
              element: D,
              actionItem: F,
    ...
    function ds(e) {
      ...
      let { store: r, computedStyle: n } = e,
        ...
        h = !f,
        y = ZV(),
        { ixElements: w, ixSession: O, ixData: C } = r.getState(),
        S = $V(w, o),
        { refState: b } = w[S] || {},
        I = ye.getRefType(o),
        P = O.reducedMotion && Ye.ReducedMotionTypes[a.actionTypeId],
        x;
      if (P && f)
        switch (
      ...
      if (
        ...
        Dy(document.body, "ix2-animation-started", y),
        u)
      ) {
        LU(r, y);
        return;
      }
      Ut({ store: r, select: ({ ixInstances: F }) => F[y], onChange: My }),
  ...
  var Gy = s((pt) => {
    ...
    function VU(e) {
      Fy(), (0, vs.startEngine)({ store: qi, rawData: e, allowEvents: !0 });
    }
    function Fy() {
      (0, vs.stopEngine)(qi);
    }
        ...
        function w(S) {
          ...
          if (((u.href = b), !(b.indexOf(":") >= 0))) {
            ...
            if (
              ...
              var P = e(u.hash);
              P.length && v.push({ link: I, sec: P, active: !1 });
              return;
            }
            if (!(b === "#" || b === "")) {
        ...
        function O() {
          ...
          t.each(v, function (I) {
            var P = I.link,
              ...
              F = x.outerHeight(),
              U = b * 0.5,
              W = x.is(":visible") && N + F - U >= S && N + U <= S + b;
        ...
        function I(L, _) {
          ...
          switch (_) {
            case "add":
              (q = L.attr("tabindex")),
                q
                  ? L.attr("data-wf-tabindex-swap", q)
                  : L.attr("tabindex", "-1");
              break;
            case "remove":
              (q = L.attr("data-wf-tabindex-swap")),
                q
                  ? (L.attr("tabindex", q),
        ...
        function N(L, _) {
          ...
          if (q !== D) {
            var M = U(L, q, D),
              ...
              z = function () {
                var ie = Date.now() - j;
                window.scroll(0, W(q, D, ie, M)),
                  ie <= M ? u(z) : typeof _ == "function" && _();
              };
            u(z);
          }
        }
      ...
      (Ky.exports = function (e) {
        ...
        function n(o) {
          ...
          function v(C) {
            ...
            (S && S.length > 1) ||
              ((a = !0),
              S ? ((u = !0), (f = S[0].clientX)) : (f = C.clientX),
              (E = f));
          }
          function h(C) {
            if (a) {
              ...
              var S = C.touches,
                b = S ? S[0].clientX : C.clientX,
                I = b - E;
              (E = b),
                Math.abs(I) > c &&
                  r &&
                  String(r()) === "" &&
                  (i("swipe", C, { direction: I > 0 ? "right" : "left" }), w());
            }
          }
          function y(C) {
      ...
      (Yy.exports = function (e, t) {
        ...
        function W(d, X) {
          ...
          V ||
            ...
            (V.button = B.find(".w-nav-button")),
            (V.container = B.find(".w-container")),
          ...
          fe &&
            ...
            _(V),
            f
              ? (K(V), V.el.on("setting" + y, q(V)))
              : (L(V),
                V.button.on("click" + y, ie(V)),
                V.menu.on("click" + y, "a", we(V)),
                V.button.on("keydown" + y, D(V)),
                V.el.on("keydown" + y, M(V))),
            Y(d, X);
        }
        function ee(d, X) {
          var B = e.data(X, y);
        ...
        function _(d) {
          ...
          (X.animOver = /^over/.test(V)),
            ...
            B.animation !== V && d.open && t.defer(z, d),
        ...
        function Y(d, X) {
          var B = e.data(X, y),
            V = (B.collapsed = B.button.css("display") !== "none");
        ...
        function vt(d, X) {
          ...
          (d.open = !0),
            d.menu.each(Bt),
            d.links.addClass(b),
            d.dropdowns.addClass(O),
            d.dropdownToggle.addClass(C),
            d.dropdownList.addClass(S),
            d.button.addClass(w);
          var B = d.config,
            V = B.animation;
          ...
          if (
            (d.overlay &&
              ((P = d.menu.prev()), d.overlay.show().append(d.menu)),
            B.animOver)
          ) {
            n(d.menu)
              .add(g)
              .set({ x: B.animDirect * wt, height: fe })
              .start({ x: 0 })
              .then(R),
          ...
          var T = l + Tr;
          n(d.menu).add(g).set({ y: -T }).start({ y: 0 }).then(R);
          function R() {
        ...
        function Ir(d) {
          var X = d.config,
            B = X.docHeight ? o.height() : u.height();
          return (
            X.animOver
              ? d.menu.height(B)
        ...
        function ce(d, X) {
          ...
          var V = "transform " + B.duration + "ms " + B.easing2,
          ...
          function p() {
            d.menu.height(""),
              ...
              d.menu.each(Rt),
              d.links.removeClass(b),
              d.dropdowns.removeClass(O),
              d.dropdownToggle.removeClass(C),
              d.dropdownList.removeClass(S),
              d.overlay &&
                d.overlay.children().length &&
                (P.length ? d.menu.insertAfter(P) : d.menu.prependTo(d.parent),
...
Webflow.require("ix2").init({
  events: {
    e: {
      ...
      target: {
        ...
        originalId:
          "645f539322b4d0ffb39babc3|2ce1e4ea-ae00-36b9-4c83-85ea2e588015",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-7": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        selector: ".accordion-item---brix.accordion-1---brix",
        originalId:
          "645f539322b4d0ffb39babc3|aec9e8fd-2010-0353-8171-58b19493e620",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-22": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "645f539322b4d0ffb39babc3|d2a82d26-fa98-d3d9-4fee-b982f88ebb4f",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-24": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "645f539322b4d0ffb39babc3|d2a82d26-fa98-d3d9-4fee-b982f88ebb40",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-26": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "645f539322b4d0ffb39babc3|d2a82d26-fa98-d3d9-4fee-b982f88ebb45",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-28": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "645f539322b4d0ffb39babc3|d2a82d26-fa98-d3d9-4fee-b982f88ebb47",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-30": {
      ...
      action: {
        ...
        actionTypeId: "SLIDE_EFFECT",
        instant: false,
        config: { actionListId: "slideInLeft", autoStopEventId: "e-31" },
      },
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "645f539322b4d0ffb39babc3|d2a82d26-fa98-d3d9-4fee-b982f88ebb5a",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-62": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "645f539322b4d0ffb39babc3|a8bd0d28-815f-d3e3-235b-e260633463d0",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-63": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "645f539322b4d0ffb39babc3|a8bd0d28-815f-d3e3-235b-e260633463f1",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-64": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "645f539322b4d0ffb39babc3|a8bd0d28-815f-d3e3-235b-e260633463db",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-66": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "645f539322b4d0ffb39babc3|a8bd0d28-815f-d3e3-235b-e260633463e6",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-68": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "645f539322b4d0ffb39babc3|a8bd0d28-815f-d3e3-235b-e260633463ba",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-69": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        selector: ".accordion-item---brix-2.accordion-1---brix",
        originalId:
          "645f539322b4d0ffb39babc3|a8bd0d28-815f-d3e3-235b-e260633463ba",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-74": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "645f539322b4d0ffb39babc3|a8bd0d28-815f-d3e3-235b-e260633463c5",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
  ...
  actionLists: {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selector: ".accordion-item---brix.accordion-1---brix",
                  selectorGuids: [
                    "dd7987bc-0359-b812-9661-5765f3c06392",
                    "dd7987bc-0359-b812-9661-5765f3c06399",
                  ],
                },
                globalSwatchId: "5c28ab3a",
                rValue: 60,
                bValue: 48,
                gValue: 132,
                aValue: 1,
    ...
    "a-7": {
      id: "a-7",
      title: "1. Close Accordion Item - BRIX 2",
      actionItemGroups: [
        {
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: ["dd7987bc-0359-b812-9661-5765f3c06390"],
                },
                value: 0,
                unit: "",
              },
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".accordion-arrow-wrap---brix-2",
                  selectorGuids: ["c7a29047-18d0-27cb-1c4c-dbc9a5555ded"],
                },
                globalSwatchId: "5c28ab3a",
                rValue: 60,
                bValue: 48,
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selector: ".accordion-item---brix-2.accordion-1---brix",
                  selectorGuids: [
                    "c7a29047-18d0-27cb-1c4c-dbc9a5555df3",
                    "c7a29047-18d0-27cb-1c4c-dbc9a5555df4",
                  ],
                },
                globalSwatchId: "",
                rValue: 0,
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".accordion-arrow-wrapper---brix-2",
                  selectorGuids: ["c7a29047-18d0-27cb-1c4c-dbc9a5555dec"],
                },
                zValue: 90,
                xUnit: "DEG",
                yUnit: "DEG",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".arrow-line---brix-2",
                  selectorGuids: ["c7a29047-18d0-27cb-1c4c-dbc9a5555def"],
                },
                globalSwatchId: "e87f776f",
                rValue: 255,
                bValue: 255,
                gValue: 255,
                aValue: 1,
    ...
    "a-6": {
      id: "a-6",
      title: "1. Open Accordion Item - BRIX ✅ 2",
      actionItemGroups: [
        {
          actionItems: [
            {
